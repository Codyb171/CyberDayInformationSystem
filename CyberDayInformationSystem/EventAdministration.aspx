        ...
        <asp:MultiView ID="ManualOrExcel" runat="server">
                            ...
                            <asp:MultiView ID="SelectedFunction" runat="server">
                                <asp:View ID="CreateEventView" runat="server">
                                    ...
                                    <asp:TableRow runat="server" HorizontalAlign="Center">
                                        ...
                                        <asp:TableCell ColumnSpan="2">
                                            <asp:TextBox ID="EventTimeTxt" runat="server" TextMode="Time"></asp:TextBox>
                                        </asp:TableCell>
                                        <asp:TableCell ColumnSpan="1">
                                ...
                                <asp:View ID="ModifyView" runat="server">
                                    ...
                                    <asp:Table ID="ModifyTbl" runat="server" HorizontalAlign="Center" Visible="false">
                                        ...
                                        <asp:TableRow runat="server" HorizontalAlign="Center">
                                            ...
                                            <asp:TableCell ColumnSpan="2">
                                                <asp:TextBox ID="NewStartTxt" runat="server" TextMode="Time"></asp:TextBox>
                                            </asp:TableCell>
                                            <asp:TableCell ColumnSpan="1">
                                        ...
                                        <asp:TableRow runat="server" HorizontalAlign="Center">
                                            ...
                                            <asp:TableCell ColumnSpan="2">
                                                <asp:TextBox ID="NewEndTxt" runat="server" TextMode="Time"></asp:TextBox>
                                            </asp:TableCell>
                                            <asp:TableCell ColumnSpan="1">
                            ...
                            <asp:MultiView ID="TaskMultiView" runat="server">
                                <asp:View ID="CreateTaskView" runat="server">
                                    ...
                                    <asp:TableRow runat="server" HorizontalAlign="Center">
                                        ...
                                        <asp:TableCell ColumnSpan="2">
                                            <asp:TextBox ID="TaskStartTimeTxt" runat="server" TextMode="Time"></asp:TextBox>
                                        </asp:TableCell>
                                        <asp:TableCell ColumnSpan="1">
                                    ...
                                    <asp:TableRow runat="server" HorizontalAlign="Center">
                                        ...
                                        <asp:TableCell ColumnSpan="2">
                                            <asp:TextBox ID="TaskEndTimeTxt" runat="server" TextMode="Time"></asp:TextBox>
                                        </asp:TableCell>
                                        <asp:TableCell ColumnSpan="1">
                                ...
                                <asp:View ID="ModTaskView" runat="server">
                                    ...
                                    <asp:Table ID="ModTaskTbl" runat="server" HorizontalAlign="Center" Visible="false">
                                        ...
                                        <asp:TableRow runat="server" HorizontalAlign="Center">
                                            ...
                                            <asp:TableCell ColumnSpan="2">
                                                <asp:TextBox ID="TaskNewStart" runat="server" TextMode="Time"></asp:TextBox>
                                            </asp:TableCell>
                                            <asp:TableCell ColumnSpan="1">
                                        ...
                                        <asp:TableRow runat="server" HorizontalAlign="Center">
                                            ...
                                            <asp:TableCell ColumnSpan="2">
                                                <asp:TextBox ID="TaskNewEnd" runat="server" TextMode="Time"></asp:TextBox>
                                            </asp:TableCell>
                                            <asp:TableCell ColumnSpan="1">
            ...
            <asp:View ID="ViewEvents" runat="server">
                <asp:Table runat="server" HorizontalAlign="Center">
                    <asp:TableRow runat="server" HorizontalAlign="Center">
                        <asp:TableCell ColumnSpan="4">
                            <asp:Label ID="SelectionLbl" runat="server" Text="Event: "></asp:Label>
                            <asp:DropDownList ID="SelectionDropDown" runat="server" ></asp:DropDownList>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow runat="server" HorizontalAlign="Center">
                        <asp:TableCell ColumnSpan="4">
                    ...
                    <asp:TableRow runat="server" HorizontalAlign="Center">
                        <asp:TableCell ColumnSpan="4">
                            <asp:Button CssClass="btn-main reg" ID="RunBtn" runat="server" Text="Run Report?" OnClick="RunBtn_OnClick" />
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow runat="server" HorizontalAlign="Center">
                        <asp:TableCell ColumnSpan="4">
                            <asp:Panel runat="server" ID="printPanel" CssClass="PrintPanel">
                                <asp:Table runat="server" ID="ReportTable" HorizontalAlign="Center">
                                    <asp:TableRow runat="server" HorizontalAlign="Center" VerticalAlign="Top">
                                        <asp:TableCell ColumnSpan="4">
