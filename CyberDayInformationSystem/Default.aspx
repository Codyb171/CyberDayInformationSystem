...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p>
                <a class="btn-main blue" href="About.aspx">Learn more &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            <h2>Interactive and Engaging Activities</h2>
            <p>
                We will be hosting several activities including: animation programming, team-building exercises, and informational sessions about careers in business and technology.<br />
        ...
        <div class="col-md-4">
            ...
            <p>
                If you are a middle school teacher that is interested in registering your students for our program, please create an account using our sign up button on the top right!<br />
                JMU staff and students who are interested in volunteering for CyberDay should also create an account.
            </p>
            <p>
                <a class="btn-main blue" href="Contact.aspx">Learn more &raquo;</a>
            </p>
        </div>
    </div>
