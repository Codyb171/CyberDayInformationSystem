...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <h3>Photo Release</h3>
       <p>I hereby grant CyberDay and their agents the absolute right and permission to use pictures, digital images, or videotapes of My Child, or 
           in which My Child may be included in whole or in part, or reproductions thereof in color or otherwise for any lawful purpose whatsoever, 
           including but not limited to use in any CyberDay publication or on the CyberDay websites, without payment or any other consideration.</p>

       <p>I hereby waive any right that I may have to inspect and/or approve the finished product or the copy that may be used in connection therewith, 
           wherein My Child's likeness appears, or the use to which it may be applied.</p>

       <p>I hereby release, discharge, and agree to indemnify and hold harmless CyberDay and their agents from all claims, demands, and causes of action 
           that I or My Child have or may have by reason of this authorization or use of My Child’s photographic portraits, pictures, digital images or 
           videotapes, including any liability by virtue of any blurring, distortion, alteration, optical illusion, or use in composite form, whether 
           intentional or otherwise, that may occur or be produced in the taking of said images or videotapes, or in processing tending towards the 
           completion of the finished product, including publication on the internet, in brochures, or any other advertisements or promotional materials.</p>
    ...
    <asp:Table ID="tblParentInfo" runat="server" HorizontalAlign="Center">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                <asp:Label ID="lblSentStatus" runat="server" Text=""></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
    </div>
